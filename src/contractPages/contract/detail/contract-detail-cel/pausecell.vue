	...
	<view class="cellBgView">
		...
		<view class="cell-text">
			...
			<view class="cell-text-right fontBlackcolor">
				<text>{{ dic.pauseCauseName||"--" }}</text>
			</view>
		</view>
		<view class="cell-text">
			<view class="cell-text-left fontsubcolor"><text>报停人员</text></view>
			<view class="cell-text-right fontBlackcolor">
		...
		<view class="cell-text">
			...
			<view class="cell-text-right fontBlackcolor">
				<text>{{ dic.machines.length||"--" }}台</text>
			</view>
		</view>
		<view class="cell-text">
...
export default {
	...
	methods: {
		goTo() {
			...
			let url = '/businessPages/pause/pause-detail?id=' + businessNostr + '&businessKey=' + businessKey;
			uni.navigateTo({
				url: url
			});
		}
