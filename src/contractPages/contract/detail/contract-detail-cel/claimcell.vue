...
<template>
	<view class="cellBgView">
		...
		<view class="cell-text">
			<view class="cell-text-left fontsubcolor"><text>索赔数量</text></view>
			<view class="cell-text-right fontBlackcolor">
				<text>{{ dic.claimMachineList.length||"--"  }}台</text>
			</view>
		</view>
		<view class="cell-text">
			<view class="cell-text-left fontsubcolor"><text>索赔总计</text></view>
			<view class="cell-text-right fontBlackcolor">
				<text>{{ dic.total||"--"}}元</text>
			</view>
		</view>
		<view class="cell-text">
			<view class="cell-text-left fontsubcolor"><text>索赔人员</text></view>
			<view class="cell-text-right fontBlackcolor">
	...
	export default {
		...
		methods: {
			goTo() {
				...
				let url = '/businessPages/claim/claim-detail?businessNo=' + businessNostr + '&businessKey=' + businessKey;
				uni.navigateTo({
					url: url
				});
			}
