    ...
    <view class="body" v-if="flag == 1">
      <view class="constructionList">
        <view
          ...
          @click="
            gotoConstruction(item.address, false, stSlice(item.dateRange))
          "
        >
          <view class="flex">
    ...
    <view class="body" v-else>
      <view class="constructionList">
        <view
          ...
          @click="
            gotoConstruction(item.address, true, strHisSlice(item.dateRange))
          "
        >
          <view class="flex">
            <view style="width: 24px">
...
export default {
  ...
  methods: {
    ...
    gotoConstruction(address, isHistory, dateRange) {
      uni.navigateTo({
        url: `/devicePages/gps/constructionDetail?address=${address}&isHistory=${isHistory}&dateRange=${dateRange}`,
      });
    },
    clickBtn() {
      /* 收款 */
