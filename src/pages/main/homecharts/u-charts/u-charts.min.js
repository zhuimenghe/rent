...
function createCurveControlPoints(e, t) {
	...
	var n = Math.min,
		...
		h = null,
		x = null;
	if (1 > t ? (s = e[0].x + (e[1].x - e[0].x) * r, d = e[0].y + (e[1].y - e[0].y) * r) : (s = e[t].x + (e[t + 1].x - e[t -
			1].x) * r, d = e[t].y + (e[t + 1].y - e[t - 1].y) * r), t > e.length - 3) {
		var c = e.length - 1;
		h = e[c].x - (e[c].x - e[c - 1].x) * a, x = e[c].y - (e[c].y - e[c - 1].y) * a
	} else h = e[t + 1].x - (e[t + 2].x - e[t].x) * a, x = e[t + 1].y - (e[t + 2].y - e[t].y) * a;
	return i(e, t + 1) && (x = e[t + 1].y), i(e, t) && (d = e[t].y), o(e, t + 1) && (h = e[t + 1].x), o(e, t) && (s = e[t]
			.x), (d >= l(e[t].y, e[t + 1].y) || d <= n(e[t].y, e[t + 1].y)) && (d = e[t].y), (x >= l(e[t].y, e[t + 1].y) || x <=
			n(e[t].y, e[t + 1].y)) && (x = e[t + 1].y), (s >= l(e[t].x, e[t + 1].x) || s <= n(e[t].x, e[t + 1].x)) && (s = e[t].x),
...
function findCurrentIndex(e, t, i, a) {
	...
	if (0 < t.length) {
		if ("candle" == i.type)
			for (let e = 0; e < t[0].length; e++) r.push(t[0][e][0].x);
		else
			for (let e = 0; e < t[0].length; e++) r.push(t[0][e].x);
		("line" == i.type || "area" == i.type) && "justify" == i.xAxis.boundaryGap && (l = i.chartData.eachSpacing / 2), i.categories ||
			(l = 0), isInExactChartArea(e, i, a) && r.forEach(function(t, i) {
				e.x + o + l > t && (n = i)
			})
	}
	return n
...
function getXAxisTextList(e, t) {
	...
	for (var x = s, c = d, p = [], g = (c - x) / t.xAxis.splitNumber, y = 0; y <= t.xAxis.splitNumber; y++) p.push(x + g *
		y);
	return p
}
				...
				case "group":
					...
					for (let e, o = 0; o < u.length; o++)
						if (e = u[o], null !== e && o > h && o < x) {
							...
							a.moveTo(S, e.y), a.lineTo(S + e.width - 2, e.y), a.lineTo(S + e.width - 2, t.height - t.area[2]), a.lineTo(S,
								t.height - t.area[2]), a.lineTo(S, e.y), a.closePath(), a.stroke(), a.fill()
						};
					break;
				case "stack":
			...
			if (d.push(S), "column" == e.type) {
				...
				for (let o, n = 0; n < S.length; n++)
					if (o = S[n], null !== o && n > c && n < p) {
						...
						a.moveTo(T, o.y), a.moveTo(T, o.y), a.lineTo(T + o.width - 2, o.y), a.lineTo(T + o.width - 2, t.height - t.area[
