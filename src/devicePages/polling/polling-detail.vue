<template>
    ...
    <s-sany-popup ref="customToast"></s-sany-popup>
		<c-nav-bar-apply :business-key="dataDic.businessKey">巡检详情</c-nav-bar-apply>
...
export default {
	...
	onLoad(options) {
		...
		this.getDetail();
		/*统计*/
		this.$gxfmethod.statisticData(this.$eventId.Device_Administrative,"设备维护","巡检记录详情");
	},
	methods: {
		isshowPart(){
		...
		getDetail() {
			...
			this.$network
				.getData(this.$url.MACHINE_POLLING_DETAIL, 'GET', param)
				.then(result => {
					this.dataDic = {
						...result,
