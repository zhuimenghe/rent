<template>
    ...
    <s-sany-popup ref="customToast"></s-sany-popup>
		<c-nav-bar-apply :business-key="insuranceDic.businessKey">保险单审批</c-nav-bar-apply>
				...
				<view class="sum-view-bg">
					...
					<view class="vehicle-list-container">
						...
						<view v-for="(v, i) in insuranceDic.machineList" class="v-item-container" :key="i">
							<view class="item-top">
								<text style="flex: 5;">{{ v.licenseId||'--' }}</text>
								<text style="flex: 3;">{{ v.printCode || '-' }}</text>
							</view>
