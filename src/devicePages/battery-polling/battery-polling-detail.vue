<template>
    ...
    <s-sany-popup ref="customToast"></s-sany-popup>
		<c-nav-bar-apply :business-key="dataDic.businessKey">电池巡检详情</c-nav-bar-apply>
		<view class="sum-view-bg">
			<view class="cell-input-view tilte-view-sub">
				<view class="cell-input-view-left boldstyle"><text>基本信息</text></view>
			</view>
			<view class="cell-input-view">
				<view class="cell-input-view-left"><text>巡检单号</text></view>
			...
			<view class="cell-input-view">
				...
				<view class="cell-input-view-right">
					<text class="input-style">{{dataDic.checkHours || "--"}}小时</text>
				</view>
			</view>
		</view>
		<view class="sum-view-bg">
			...
			<view class="cell-input-view">
				...
				<view class="cell-input-view-right">
					<text class="input-style">{{ $datestr.doubleFloat(dataDic.checkDuration) || "--"}}小时</text>
				</view>
			</view>
			<view class="cell-input-view">
			...
			<view class="cell-input-view">
				<view class="cell-input-view-left"><text>巡检地址</text></view>
				<view class="cell-input-view-right">
			...
			<view class="cell-input-view">
				<view class="cell-input-view-left"><text>巡检金额</text></view>
				<view class="cell-input-view-right">
			...
			<view class="cell-input-view">
				...
				<view class="cell-input-view-right">
					<text class="input-style">{{dataDic.showRulesName || "--"}}</text>
				</view>
			</view>
			<view class="cell-input-view">
...
export default {
	...
	onLoad(options) {
		...
		this.getDetail();
		/*统计*/
		this.$gxfmethod.statisticData(this.$eventId.Device_Administrative,"设备维护","电池巡检记录详情");
	},
	methods: {
		isshowPart(){
		...
		getDetail() {
			...
			this.$network
				.getData(this.$url.BATTERY_POLLING_DETAIL, 'GET', param)
				.then(result => {
					this.dataDic = {
						...result,
