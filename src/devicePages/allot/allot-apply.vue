			...
			<view class="detail-allot-bg">
				<view class="sum-view-bg" style="margin-bottom: 5px;">
					<view class="cell-input-view">
						<view class="cell-input-view-left"><text style="font-weight: bold;">基本信息</text></view>
					</view>
					...
					<view class="cell-input-view">
						...
						<view class="cell-input-view-right"><input class="input-style" v-model="allotDic.reason" disabled="true" /></view>
					</view>
				...
				<view class="sum-view-bg">
					<view class="cell-input-view" style="border-bottom-width: 1px;border-bottom-color: #eeeeee;border-bottom-style: solid;">
						<view class="cell-input-view-left">
							<text style="font-weight: bold;">设备信息（共{{ allotDic.machineAllocationList ? allotDic.machineAllocationList.length : '0' }}辆）</text>
						</view>
					</view>
				...
				<view class="sum-view-bg" v-if="allotDic.needLogistics">
					...
					<select-label-item tagName="物流公司" :isSelect="false" :value="allotDic.logisticsRecord && allotDic.logisticsRecord.logisticsCompanyName" />
					<select-label-item tagName="物流联系人" :isSelect="false" :value="allotDic.logisticsRecord && allotDic.logisticsRecord.logisticsContact" />
					<select-label-item tagName="物流电话" :isPhone="true" :isSelect="false" :value="allotDic.logisticsRecord && allotDic.logisticsRecord.logisticsPhone" />
					<select-label-item tagName="物流费用" :isSelect="false" :value="allotDic.logisticsRecord && allotDic.logisticsRecord.logisticsCarriage" />
					<select-label-item tagName="物流运输时间" :isSelect="false" :value="changestr(allotDic.logisticsRecord && allotDic.logisticsRecord.transportTime)" />
				</view>
			</view>
		</approve-step>
