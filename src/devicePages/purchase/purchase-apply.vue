<template>
    ...
    <s-sany-popup ref="customToast"></s-sany-popup>
		<c-nav-bar-apply :business-key="purchaseDic.businessKey">采购审批</c-nav-bar-apply>
		<approve-step :itemData="itemData" @data-form="dataForm">
			<view class="creat-claime-bg">
				<view class="sum-view-bg">
					...
					<select-label-item tagName="采购形式" :isRequired="true" :value="purchaseDic.purchaseTypeName||'--'" :isSelect="false" />
					<select-label-item tagName="采购日期" :isRequired="true" :value="getDate(purchaseDic.purchaseDate)" :isSelect="false" />
					<select-label-item tagName="采购人" :isRequired="true" :value="purchaseDic.purchaseUserName||'--'" :isSelect="false" />
