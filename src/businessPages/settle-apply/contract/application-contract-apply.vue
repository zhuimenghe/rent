	...
	<view class="content">
		...
		<approve-step :itemData="itemData" @data-form="dataForm">
			<view class="sum-view-bg">
				...
				<select-label-item tagName="合同名称" :isRequired="true" valueColor='#E60000' :value="contractDicName" :icon="righticon"
	...
	export default {
		...
		methods: {
			...
			dataForm(val) {
				...
				this.contractDicName = this.applyDic.customerName + '-' + this.applyDic.contractInfoDtoList[
					0].projectName;
