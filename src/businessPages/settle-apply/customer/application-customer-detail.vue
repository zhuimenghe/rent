	...
	<view class="content">
		...
		<view class="creat-bg">
			<view class="sum-view-bg">
				...
				<select-label-item tagName="客户名称" :isRequired="true" :value="applyDic.customerName" :isSelect="false" />
				...
				<view class="vehicle-list-container">
					<view v-for="(v, i) in applyDic.contractInfoDtoList" class="v-item-container" :key="i">
						<view class="item-col">
							...
							<view class="item-row">
								<tag-select :tagName="(typeName?typeName:'')+'开始时间'" :value="getDate(v.beginDate)"
								 :textColor="textColor" :fontSize="fontSize" :isSelect="false"/>
								<tag-select :tagName="(typeName?typeName:'')+'结束时间'" :value="getDate(v.endDate)" 
								 :textColor="textColor" :fontSize="fontSize" :isSelect="false"/>
							</view>
						</view>
					</view>
