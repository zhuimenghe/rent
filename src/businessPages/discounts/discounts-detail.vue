<template>
	<view class="content">
		<c-nav-bar-apply :business-key="detailDic.businessKey">优惠/增收详情</c-nav-bar-apply>
		<view class="sum-view-bg">
			<select-label-item tagName="调整单号" :isRequired="false" :isSelect="false" :value="detailDic.businessNo" />
			<select-label-item tagName="合同名称" :isRequired="false" valueColor='#E60000' :value="contractDicName" :isSelect="true"/>
			<view v-if="detailDic.contractNo">
				...
				<select-label-item tagName="调整类型" :isRequired="false" :value="detailDic.adjustType?(detailDic.adjustType=='reduce'?'优惠':'增收'):'-'"
				 :isSelect="false" />
