<template>
	<view class="query-content">
		<view class="query-top-container">
			<view class="query-search-box" v-if="isQueryfuzzyParam">
			...
			<view class="query-export-css" :style="{border:isBorder?'1px solid #E60000':'none',color:isBorder?'#E60000':'#222'}"  @click="exportExcel" v-if="isExportList">
				<text>导出</text>
			</view>
			<view class="query-more-css" @click="setMore" v-if="haveMore">
				<text>筛选</text>
			</view>
		</view>
