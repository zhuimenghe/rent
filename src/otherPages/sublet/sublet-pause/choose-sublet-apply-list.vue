      ...
      <view class="search-container">
        <view class="search-box">
          ...
          <view class="search-content">
            <input style="flex: 1" placeholder="转租公司/联系人" @input="searchChange" />
          </view>
        </view>
      </view>
    </view>
      ...
      <list class="list-view">
        <cell class="list-view-cell" v-for="(item, index) in datalist" :key="index">
          <view @click="goTo(item)">
            ...
            <view class="cell-text">
              <view class="cell-text-left fontsubcolor"><text>转租单</text></view>
              <view class="cell-text-right fontBlackcolor">
                <text>{{ item.orderCount || 0 }}</text>
              </view>
            </view>
            <view class="cell-text">
              <view class="cell-text-left fontsubcolor"><text>转租中</text></view>
              <view class="cell-text-right fontBlackcolor">
            ...
            <view class="cell-text">
              <view class="cell-text-left fontsubcolor"><text>已还租</text></view>
              <view class="cell-text-right fontBlackcolor">
...
export default {
  ...
  methods: {
    ...
    goTo(item) {
      uni.navigateTo({
        url:
          "./choose-sublet-compay-carlist?back=2&item=" +
