<template>
  <view class="uni-date">
    <view class="uni-date-editor" @click="show">
      <slot>
        <view class="uni-date-editor--x" :class="{
    ...
    <view v-if="!isPhone" ref="datePicker" v-show="popup" class="uni-date-picker__container">
      <view v-if="!isRange" class="uni-date-single--x" :style="popover">
        ...
        <view v-if="hasTime" class="uni-date-changed popup-x-header">
          ...
          <time-picker type="time" v-model="time" :border="false" :disabled="!tempSingleDate" :start="reactStartTime" :end="reactEndTime" :hideSecond="hideSecond"
            style="width: 100%">
      ...
      <view v-else class="uni-date-range--x" :style="popover">
        ...
        <view class="popup-x-body">
          <calendar ref="left" :showMonth="false" :start-date="caleRange.startDate" :end-date="caleRange.endDate" :range="true" @change="leftChange" :pleStatus="endMultipleStatus"
            @firstEnterCale="updateRightCale" @monthSwitch="leftMonthSwitch" style="padding: 0 8px" />
          <calendar ref="right" :showMonth="false" :start-date="caleRange.startDate" :end-date="caleRange.endDate" :range="true" @change="rightChange"
            :pleStatus="startMultipleStatus" @firstEnterCale="updateLeftCale" @monthSwitch="rightMonthSwitch" style="padding: 0 8px; border-left: 1px solid #f1f1f1" />
        </view>
        <view v-if="hasTime" class="popup-x-footer">
    ...
    <calendar v-show="isPhone" ref="mobile" :clearDate="false" :date="defSingleDate" :defTime="reactMobDefTime" :start-date="caleRange.startDate" :end-date="caleRange.endDate"
      :selectableTimes="mobSelectableTime" :pleStatus="endMultipleStatus" :showMonth="false" :range="isRange" :typeHasTime="hasTime" :insert="false" :hideSecond="hideSecond"
