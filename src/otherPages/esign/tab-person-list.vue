<template>
    ...
    <s-sany-popup ref="customToast"></s-sany-popup>
		<view class="search-top">
			...
			<flexibleQueryView :isExportList='false' hint='客户名称/手机号' :isQuerySalesman="true" :isQueryOrg='true' :isCustomQuery="true"
			 :customList='isRegistList' customHint='是否关联电签' @reset='reset' @query="query" />
