...
import repair from './notify-record-repair.vue';
import maintain from './notify-record-maintain.vue';
import hostling from './notify-record-hostling.vue';
import polling from './notify-record-polling.vue';
import battery from './notify-record-battery.vue';
